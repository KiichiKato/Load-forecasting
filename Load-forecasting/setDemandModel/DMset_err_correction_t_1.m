function y = DMset_err_correction_t_1(shortTermPastData,path)
% tic;
...
%         ShortExcelFile = shortTermPastData((end-96*1+1):end,:);
    ...
    old_format_ShortData = DMset_format_change_1(ShortData);
    ...
    real_demand = old_format_ShortData(:,7:102);
